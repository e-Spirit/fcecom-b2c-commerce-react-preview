 ...
 * === CFC ===
 * Applied changes:
 * - Changed locale to path and enabled showDefaults to include locale in the url to enable language switch.
 */
...
module.exports = {
  app: {
    ...
    /** CFC Start **/
    defaultSite: process.env.SITE_ID,
    /** CFC End **/
    ...
    // Einstein api config
    // Working demo credentials as we don't use Einstein
    einsteinAPI: {
  ...
  ssrParameters: {
    ...
    proxyConfigs: [
      /** CFC Start **/
      {
        host: `${process.env.SHORT_CODE}.api.commercecloud.salesforce.com`,
        path: 'api',
      },
      {
        host: process.env.B2C_URL,
        path: 'ocapi',
      },
      /** CFC End **/
    ],
