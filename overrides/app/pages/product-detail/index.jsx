 ...
 * - Add EcomPage payload: product page with product template
 * - Add page slots 'stage'and 'sub_content'
...
import { useCategory, useCustomerId, useProduct, useShopperBasketsMutation, useShopperCustomersMutation } from '@salesforce/commerce-sdk-react';
...
const ProductDetail = () => {
  ...
  return (
    ...
    >
      {/** CFC End */}
      <Box className="sf-product-detail-page" layerStyle="page" data-testid="product-details-page">
        <Helmet>
        ...
        <Stack spacing={16}>
                ...
                product.setProducts.map((childProduct) => (
                  <Box key={childProduct.id} data-testid="child-product">
                    <ProductView
                      ...
                      addToCart={(variant, quantity) => handleAddToCart([{ product: childProduct, variant, quantity }])}
                      addToWishlist={handleAddToWishlist}
          ...
          <Stack spacing={16}>
            {!isProductASet && (
              <RecommendedProducts
                title={<FormattedMessage defaultMessage="Complete the Set" id="product_detail.recommended_products.title.complete_set" />}
            ...
            <RecommendedProducts
              title={<FormattedMessage defaultMessage="You might also like" id="product_detail.recommended_products.title.might_also_like" />}
            ...
            <RecommendedProducts
              ...
              key={location.key}
              title={<FormattedMessage defaultMessage="Recently Viewed" id="product_detail.recommended_products.title.recently_viewed" />}
